          ...
          {teamMembers.map((member) => (
            <div key={member.name} className="group">
              ...
              <div className="flex gap-2">
                ...
                <a href="#" className="w-16 h-8 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-accent hover:border-accent transition-colors">
